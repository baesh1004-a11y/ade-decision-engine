...
## Decision Desk · 2026-09-10

기본 대시보드는 추천 목록, 추천 시점의 현재·과거 120거래일 비교, STO 3계층, 검토 메모와 주문 후보를 하나의 작업 화면으로 연결합니다. 검토할 추천 실행을 고정할 수 있으며, 새 계산이 0건으로 끝나면 그 결과를 그대로 표시합니다.
