...
class MoneyExplosionEventFilter:
    """Find replay start events: money explodes first, then structure is analyzed."""

    def __init__(self, min_ratio_120d: float = 10.0) -> None:
    ...
    def _event_at(self, market: str, ticker: str, name: str | None, df: pd.DataFrame, index: int) -> MoneyExplosionEvent | None:
        ...
        if ratio120 < self.min_ratio_120d:
            return None
