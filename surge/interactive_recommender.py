...
class InteractiveSurgePatternRecommender(MultiHorizonSurgePatternRecommender):
    """Multi-horizon recommender with cooperative progress and cancellation hooks."""
    ...
    def recommend_interactive(
        ...
        del candidate_years, lookback_months  # retained for API compatibility
