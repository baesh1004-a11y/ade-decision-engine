...
PAGES = {
    ...
    "추천 워크벤치": [
        st.Page("pages/14_Recommendation_Workbench.py", title="통합 추천 워크벤치", icon="📊"),
        st.Page("pages/7_Daily_Center.py", title="한국 추천 생성", icon="🇰🇷"),
        st.Page("pages/10_US_Daily_Center.py", title="미국 추천 생성", icon="🇺🇸"),
    ...
    "포트폴리오": [
        st.Page("pages/1_ADE_Cockpit.py", title="포트폴리오 현황", icon="💼"),
